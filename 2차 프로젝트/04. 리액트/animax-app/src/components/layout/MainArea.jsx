                ...
                <section className="list-banner_wrap">
                    ...
                    <div className="list-banner_box">
                        <div className="arrow_box">
                            <a href="#" className="arrow_btn prev_btn"><span className="sr-only">이전 슬라이드 보기</span></a>
                            <a href="#" className="arrow_btn next_btn"><span className="sr-only">다음 슬라이드 보기</span></a>
                        </div>
                        <div className="lb">
                    ...
                    <div className="paging_wrap">
                        <ol className="paging_list">
                            <li><a href="#" className="paging_btn">1</a></li>
                            <li><a href="#" className="paging_btn">2</a></li>
                            <li className="on"><a href="#" className="paging_btn">3</a></li>
                            <li><a href="#" className="paging_btn">4</a></li>
                            <li><a href="#" className="paging_btn">5</a></li>
                            <li><a href="#" className="paging_btn">6</a></li>
                        </ol>
                ...
                <section className="content_wrap">
                    ...
                    <article className="pr-banner_wrap">
                        ...
                        <div className="pr-banner">
                            <a href="#"><img src="./images/banner/line_banner.png"
                                    alt="명탐정 코난 앙상블스타즈 콜라보 캠페인 진행중" /></a>
                        </div>
                    </article>
                    {/* 2.3.1 오늘의 업데이트 리스트 */}
                    <article className="list_wrap today">
                        ...
                        <div className="list-ctl_box">
                            <ol className="paging_list">
                                <li><a href="#" className="paging_btn">1</a></li>
                                <li className="on"><a href="#" className="paging_btn">2</a></li>
                                <li><a href="#" className="paging_btn">3</a></li>
                                <li><a href="#" className="paging_btn">4</a></li>
                            </ol>
                            <a href="#" title="오늘의 업데이트 더보기" className="more_btn">더보기</a>
                        </div>
                        <div className="list_box">
                            ...
                            <ul className="thum-list">
                                <li className="on">
                                    <a href="#" title="동영상 재생" className="link_play">
                                        <span className="tootip">재생하기</span>
                                    </a>
                                    <a href="#" title="정보 더보기" className="link_info">
                                        <span className="tootip">상세보기</span>
                                    </a>
                                    <a href="#" title="찜하기" className="link_zzim">
                                    ...
                                    <a href="#" className="link_img">
                                        ...
                                        <h4>
                                            <span className="tit">코드 기아스 반역의 를르슈 코드 기아스 반역의
                                                를르슈코드</span>
                                            <span className="txt">STAGE 2 각성한 하얀 기사 STAGE 2 각성한 하얀
                                                기사STAGE 2 각성한 하얀 기사</span>
                                        </h4>
                                    </a>
                                </li>
                                <li>
                    ...
                    <article className="list_v2_wrap rank">
                        <h3>
                            ...
                            <span className="tab_btn">
                                <button type="button" className="on">월별</button>
                        ...
                        <div className="list_box">
                            ...
                            <ul className="thum-list">
                                <li className="on">
                                    ...
                                    <a href="#" className="link_img">
                                        <em className="em on">1</em>
                                        <div className="img">
                                            <div className="bg"></div>
                                            <img src="./images/banner/rank_banner01.jpg" alt="" />
                                        </div>
                                        <h4>
                                            <span className="tit">무직전생 Ⅱ ~이세계에 갔으면 최선을 다한다~</span>
                            ...
                            <dl className="live_bx">
                                <dt className="live_img_bx">
                                    <div className="live_video">
                                        ...
                                        <div className="ctl_box">
                                            <button className="play_btn"><img src="./images/sound.png" alt="" /></button>
                                        </div>
                                    </div>
                                ...
                                <dd className="live_cont">
                                    <div className="text-group">
                                        <span className="sm-logo"><img src="./images/banner/live_logo.png" alt="" /></span>
                                        <h4 className="tit">
                                        ...
                                        <p className="txt">FOS의 오프라인 이벤트에서 우연히 '야마다'를 발견한 아카네가 전 남친 (with 새로운 여친)과 조우했을 때 충동적으로
                                            야마다를 자신의 남친이라고 소개하고 만다. 그것을 보상하기 위해 들어간 요리 주점에서 아카네는 잔뜩 취해 야마다의 집에서 신세를 지게 되고
                                            추억이 담긴 목걸이를 잃어버리는 큰 실수를 저지른다. 아카네는 목걸이를 찾기 위해 FOS의 길드 룸에서 만난 야마다에게 연락한다. 하지만
                                            야마다로부터</p>
                                        <span className="btn_wrap">
                                            <a href="#" className="btn play_btn"><span className="txt">지금 감상하기</span></a>
                                            <a href="#" className="btn info_btn"><span className="txt">작품 상세보기</span></a>
                                        </span>
                                    </div>
                    ...
                    <article className="list_v2_wrap tag">
                        <h3>
                            인기 태그 작품
                            <span className="tab_btn">
                                <button type="button" className="on">#이능력</button>
